    ...
    return (
        <>
            ...
            <div className="container p-4 slider relative  h-96 my-8 overflow-hidden">
                <div className="slider-wrapper absolute h-full w-full flex gap-3 duration-1000 " style={{ width: `${laptopsData.length * 240}px`, right: `${240 * sliderIndex}px` }} >
                ...
                <button disabled={!(sliderIndex - 1 > -laptopsData.length)} onClick={() => slide("toleft")}>
