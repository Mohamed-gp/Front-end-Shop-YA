        ...
        <>
            <header className='bg-blue-400 text-white text-xl font-bold'>
                ...
                <div className='bottom-header bg-[#2c3e50] py-4'>
                    <div className="container p-4 flex justify-between items-center flex-wrap gap-4">
                        ...
                        <nav className='absolute w-1/2  bg-[#2c3e50] lg:bg-transparent right-0 top-0 menu h-full z-30 lg:static clipPath-closed duration-1000'>
